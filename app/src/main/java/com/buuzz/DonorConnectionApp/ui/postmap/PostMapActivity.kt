package com.buuzz.DonorConnectionApp.ui.postmap
...
import com.buuzz.DonorConnectionApp.databinding.ActivityPostMapBinding
...
class PostMapActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadWebView("http://192.168.100.37:8000/api/map/showMap")
